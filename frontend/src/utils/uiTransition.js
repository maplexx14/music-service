...
// Плеер с view-transition-name: fullscreen-player (инлайн-стиль в
// FullScreenPlayer.jsx) выезжает/уезжает как drawer поверх статичной
// страницы — снапшот рута при этом не меняется.
//
