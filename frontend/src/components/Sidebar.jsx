...
import { Home, Search, Heart, LogOut, Upload, Settings, ChevronLeft, ChevronRight, ShieldCheck, User, SlidersHorizontal } from 'lucide-react'
        ...
        <div className="profile-container">
          ...
          {isUserMenuOpen && (
            <div className="profile-dropdown">
              ...
              <Link to="/preferences" className="dropdown-item" onClick={() => setIsUserMenuOpen(false)}>
