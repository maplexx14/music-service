...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-14 (commit 9941dea). Confidence: 97%.
...
- `frontend/src/store/authStore.js` — 1 bug fix, last fix 4 days ago; 6 commits/90d

### Code health
Three co-equal signals: defect risk 5.52/10 avg, hotspot health 3.28/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.32/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
