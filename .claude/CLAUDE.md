...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-21 (commit 0dcf434). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 9 bug fixes, last fix today (bug magnet); 49 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 7 days ago (bug magnet); 45 commits/90d
- `backend/tests/test_flow.py` — 4 bug fixes, last fix today (bug magnet); 22 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.32/10 avg, hotspot health 3.39/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.21/10 · performance risk 57 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
