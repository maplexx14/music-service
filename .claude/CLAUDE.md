...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-05 (commit d6d8788). Confidence: 95%.
...
- `frontend/src/components/Grainient.jsx` — 1 bug fix, last fix 3 days ago; 3 commits/90d
- `frontend/src/components/Player.jsx` — 1 bug fix, last fix 3 weeks ago; 26 commits/90d
- `backend/app/routers/ytdlp.py` — 22 commits/90d
- `backend/app/routers/flow.py` — 21 commits/90d
- `backend/app/routers/tracks.py` — 19 commits/90d

### Code health
Three co-equal signals: defect risk 5.12/10 avg, hotspot health 2.48/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 6.8/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `frontend/src/components/Player.jsx` — untested hotspot — impact −2.0
