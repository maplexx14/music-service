...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-18 (commit 590b398). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 6 bug fixes, last fix today (bug magnet); 43 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 4 days ago (bug magnet); 44 commits/90d
- `backend/tests/test_flow.py` — 3 bug fixes, last fix today; 19 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.76/10 avg, hotspot health 3.89/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.47/10 · performance risk 43 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
