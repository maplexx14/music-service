...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-11 (commit 7a49142). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.22/10 avg, hotspot health 3.36/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.2/10 · performance risk 79 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
