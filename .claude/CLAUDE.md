...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-25 (commit e6928ae). Confidence: 97%.
...
- `backend/app/routers/ytdlp.py` — 11 bug fixes, last fix 6 days ago (bug magnet); 38 commits/90d
- `frontend/src/components/Player.jsx` — 11 bug fixes, last fix 12 days ago (bug magnet); 54 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.25/10 avg, hotspot health 3.34/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.25/10 · performance risk 85 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
