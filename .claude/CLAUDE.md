...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-06 (commit f470785). Confidence: 97%.
...
- `backend/app/routers/recommendations.py` — 8 bug fixes, last fix 9 days ago (bug magnet); 29 commits/90d
- `backend/app/routers/ytdlp.py` — 7 bug fixes, last fix today (bug magnet); 33 commits/90d
- `backend/app/schemas.py` — 7 bug fixes, last fix 6 days ago (bug magnet); 29 commits/90d

### Code health
Three co-equal signals: defect risk 5.22/10 avg, hotspot health 3.35/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.19/10 · performance risk 78 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
