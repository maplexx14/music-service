...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-27 (commit 7083498). Confidence: 97%.
...
- `backend/app/routers/recommendations.py` — 5 bug fixes, last fix today (bug magnet); 25 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.47/10 avg, hotspot health 3.51/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.22/10 · performance risk 73 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
