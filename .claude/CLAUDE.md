...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-19 (commit 3ed7595). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 6 bug fixes, last fix today (bug magnet); 45 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 4 days ago (bug magnet); 44 commits/90d
- `backend/tests/test_flow.py` — 3 bug fixes, last fix today; 20 commits/90d
- `invidious/proxy-pool/rotate.sh` — 3 bug fixes, last fix today; 5 commits/90d
- `backend/app/routers/ytdlp.py` — 2 bug fixes, last fix yesterday; 27 commits/90d

### Code health
Three co-equal signals: defect risk 5.75/10 avg, hotspot health 3.89/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.46/10 · performance risk 43 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
