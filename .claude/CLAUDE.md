...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-07 (commit 3384931). Confidence: 95%.
...
- `frontend/src/components/Player.jsx` — 3 bug fixes, last fix yesterday; 30 commits/90d
- `frontend/src/components/Grainient.jsx` — 1 bug fix, last fix 5 days ago; 3 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.28/10 avg, hotspot health 3.17/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.06/10 · performance risk 41 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
