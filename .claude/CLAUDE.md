...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-23 (commit 342b639). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 13 bug fixes, last fix today (bug magnet); 57 commits/90d
- `backend/tests/test_flow.py` — 8 bug fixes, last fix today (bug magnet); 29 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 8 days ago (bug magnet); 45 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.27/10 avg, hotspot health 3.47/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.14/10 · performance risk 61 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
