...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-31 (commit 9be302e). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.37/10 avg, hotspot health 3.58/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.24/10 · performance risk 75 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
