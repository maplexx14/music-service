...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-12 (commit 5a0f911). Confidence: 97%.
...
- `backend/app/schemas.py` — 7 bug fixes, last fix 12 days ago (bug magnet); 29 commits/90d

### Code health
Three co-equal signals: defect risk 5.23/10 avg, hotspot health 3.39/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.2/10 · performance risk 81 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `backend/app/routers/users.py` — untested hotspot — impact −2.0
