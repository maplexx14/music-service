...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-05 (commit 6208a71). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 16 bug fixes, last fix 8 days ago (bug magnet); 65 commits/90d
- `backend/tests/test_flow.py` — 9 bug fixes, last fix 8 days ago (bug magnet); 33 commits/90d
- `backend/app/routers/recommendations.py` — 8 bug fixes, last fix 8 days ago (bug magnet); 29 commits/90d
- `backend/app/schemas.py` — 7 bug fixes, last fix 5 days ago (bug magnet); 29 commits/90d
- `frontend/src/components/Player.jsx` — 6 bug fixes, last fix 8 days ago (bug magnet); 47 commits/90d

### Code health
Three co-equal signals: defect risk 5.23/10 avg, hotspot health 3.36/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.2/10 · performance risk 81 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
