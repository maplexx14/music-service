...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-13 (commit cb7c77f). Confidence: 96%.
...
- `frontend/src/components/Player.jsx` — 4 bug fixes, last fix 4 days ago (bug magnet); 40 commits/90d
...
- `frontend/src/services/audioEngine.js` — 1 bug fix, last fix 4 days ago; 7 commits/90d
- `frontend/src/components/Grainient.jsx` — 1 bug fix, last fix 10 days ago; 3 commits/90d

### Code health
Three co-equal signals: defect risk 5.32/10 avg, hotspot health 2.83/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.21/10 · performance risk 43 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `frontend/src/pages/Home.jsx` — untested hotspot — impact −2.0
