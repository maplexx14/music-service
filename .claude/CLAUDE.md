...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-13 (commit 2f05303). Confidence: 96%.
...
### Code health
Three co-equal signals: defect risk 5.33/10 avg, hotspot health 2.84/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.21/10 · performance risk 43 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
