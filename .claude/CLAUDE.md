...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-26 (commit 3f84d71). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 18 bug fixes, last fix 2 weeks ago (bug magnet); 67 commits/90d
- `backend/app/routers/ytdlp.py` — 11 bug fixes, last fix 7 days ago (bug magnet); 38 commits/90d
- `frontend/src/components/Player.jsx` — 11 bug fixes, last fix 13 days ago (bug magnet); 54 commits/90d
- `backend/app/routers/recommendations.py` — 10 bug fixes, last fix 2 weeks ago (bug magnet); 32 commits/90d
- `backend/tests/test_flow.py` — 9 bug fixes, last fix 4 weeks ago (bug magnet); 33 commits/90d

### Code health
Three co-equal signals: defect risk 5.27/10 avg, hotspot health 3.36/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.26/10 · performance risk 85 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `backend/app/artist_utils.py` — untested hotspot — impact −2.0
- `backend/app/models.py` — untested hotspot — impact −2.0
