...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-21 (commit 6986a84). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 7 bug fixes, last fix today (bug magnet); 47 commits/90d
...
- `backend/app/diversity.py` — 2 bug fixes, last fix today; 10 commits/90d

### Code health
Three co-equal signals: defect risk 5.28/10 avg, hotspot health 3.2/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.22/10 · performance risk 58 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
