...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-21 (commit 567aeb0). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 9 bug fixes, last fix today (bug magnet); 50 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 7 days ago (bug magnet); 45 commits/90d
- `backend/tests/test_flow.py` — 4 bug fixes, last fix today (bug magnet); 23 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.34/10 avg, hotspot health 3.46/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.19/10 · performance risk 59 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
