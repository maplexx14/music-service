...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-22 (commit 2b551a5). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 13 bug fixes, last fix today (bug magnet); 55 commits/90d
- `backend/tests/test_flow.py` — 8 bug fixes, last fix today (bug magnet); 28 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.26/10 avg, hotspot health 3.45/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.14/10 · performance risk 61 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
