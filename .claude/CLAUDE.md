...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-10 (commit 30c8934). Confidence: 96%.
...
- `frontend/src/components/Player.jsx` — 4 bug fixes, last fix 2 days ago (bug magnet); 40 commits/90d
- `frontend/src/pages/Search.jsx` — 1 bug fix, last fix today; 20 commits/90d
- `frontend/src/services/audioEngine.js` — 1 bug fix, last fix 2 days ago; 7 commits/90d
- `frontend/src/components/Grainient.jsx` — 1 bug fix, last fix 8 days ago; 3 commits/90d
- `backend/app/routers/ytdlp.py` — 23 commits/90d

### Code health
Three co-equal signals: defect risk 5.19/10 avg, hotspot health 3.19/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.0/10 · performance risk 40 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
