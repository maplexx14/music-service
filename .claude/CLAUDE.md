...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-14 (commit c1ff15d). Confidence: 97%.
...
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix today (bug magnet); 44 commits/90d
- `backend/app/routers/tracks.py` — 1 bug fix, last fix today; 20 commits/90d
- `backend/app/routers/recommendations.py` — 1 bug fix, last fix today; 16 commits/90d
- `frontend/src/pages/Search.jsx` — 1 bug fix, last fix 4 days ago; 20 commits/90d
- `frontend/src/store/authStore.js` — 1 bug fix, last fix 4 days ago; 8 commits/90d

### Code health
Three co-equal signals: defect risk 5.64/10 avg, hotspot health 3.62/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.35/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
