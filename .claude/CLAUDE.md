...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-21 (commit ceba7fe). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 8 bug fixes, last fix today (bug magnet); 48 commits/90d
...
- `backend/tests/test_flow.py` — 3 bug fixes, last fix 2 days ago; 21 commits/90d
- `invidious/proxy-pool/rotate.sh` — 3 bug fixes, last fix 2 days ago; 5 commits/90d

### Code health
Three co-equal signals: defect risk 5.29/10 avg, hotspot health 3.33/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.21/10 · performance risk 57 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
