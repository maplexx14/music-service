...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-18 (commit f27c3d2). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 3 bug fixes, last fix 2 days ago; 37 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.85/10 avg, hotspot health 3.82/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.46/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
