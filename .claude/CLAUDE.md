...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-05 (commit d49216d). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.23/10 avg, hotspot health 3.36/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.2/10 · performance risk 79 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
