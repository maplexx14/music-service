...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-14 (commit f34ce36). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.48/10 avg, hotspot health 3.26/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.32/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `.claude/CLAUDE.md` — prior defect — impact −2.0
