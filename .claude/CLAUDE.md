...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-28 (commit cb26c63). Confidence: 97%.
...
- `backend/app/routers/recommendations.py` — 7 bug fixes, last fix today (bug magnet); 27 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 13 days ago (bug magnet); 45 commits/90d
- `frontend/src/components/FullScreenPlayer.jsx` — 3 bug fixes, last fix today; 21 commits/90d

### Code health
Three co-equal signals: defect risk 5.29/10 avg, hotspot health 3.36/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.18/10 · performance risk 82 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
