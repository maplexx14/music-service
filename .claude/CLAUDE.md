...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-31 (commit 6e8037e). Confidence: 97%.
...
- `backend/app/routers/recommendations.py` — 8 bug fixes, last fix 3 days ago (bug magnet); 29 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.38/10 avg, hotspot health 3.59/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.24/10 · performance risk 75 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
