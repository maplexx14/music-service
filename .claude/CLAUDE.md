...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-16 (commit aa97f1e). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 1 bug fix, last fix today; 32 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.68/10 avg, hotspot health 3.7/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.37/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
