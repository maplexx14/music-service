...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-18 (commit 63d5de6). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.8/10 avg, hotspot health 3.82/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.42/10 · performance risk 41 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
