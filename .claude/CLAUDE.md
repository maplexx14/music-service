...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-06 (commit 99232c8). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 17 bug fixes, last fix today (bug magnet); 66 commits/90d
- `backend/app/routers/recommendations.py` — 9 bug fixes, last fix today (bug magnet); 30 commits/90d
- `backend/tests/test_flow.py` — 9 bug fixes, last fix 9 days ago (bug magnet); 33 commits/90d
- `backend/app/routers/ytdlp.py` — 8 bug fixes, last fix today (bug magnet); 34 commits/90d
- `backend/app/schemas.py` — 7 bug fixes, last fix 6 days ago (bug magnet); 29 commits/90d

### Code health
Three co-equal signals: defect risk 5.22/10 avg, hotspot health 3.35/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.19/10 · performance risk 79 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
