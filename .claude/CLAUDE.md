...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-10 (commit 8341775). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 18 bug fixes, last fix today (bug magnet); 67 commits/90d
- `backend/app/routers/recommendations.py` — 10 bug fixes, last fix today (bug magnet); 31 commits/90d
- `backend/app/routers/ytdlp.py` — 9 bug fixes, last fix today (bug magnet); 35 commits/90d
- `backend/tests/test_flow.py` — 9 bug fixes, last fix 13 days ago (bug magnet); 33 commits/90d
- `backend/app/schemas.py` — 7 bug fixes, last fix 10 days ago (bug magnet); 29 commits/90d

### Code health
Three co-equal signals: defect risk 5.19/10 avg, hotspot health 3.31/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.17/10 · performance risk 79 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
