...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-21 (commit 8965b17). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.28/10 avg, hotspot health 3.23/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.2/10 · performance risk 58 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
