...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-05 (commit b3cb5f4). Confidence: 95%.
...
- `frontend/src/components/Player.jsx` — 3 bug fixes, last fix today; 28 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.15/10 avg, hotspot health 2.81/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 6.98/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
