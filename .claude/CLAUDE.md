...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-14 (commit b5c9154). Confidence: 97%.
...
- `frontend/src/store/authStore.js` — 1 bug fix, last fix 4 days ago; 7 commits/90d

### Code health
Three co-equal signals: defect risk 5.57/10 avg, hotspot health 3.46/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.3/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
