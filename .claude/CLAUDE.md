...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-21 (commit d1f1884). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 10 bug fixes, last fix today (bug magnet); 51 commits/90d
- `backend/tests/test_flow.py` — 5 bug fixes, last fix today (bug magnet); 24 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 7 days ago (bug magnet); 45 commits/90d
- `backend/app/routers/recommendations.py` — 3 bug fixes, last fix today; 21 commits/90d
- `backend/app/routers/ytdlp.py` — 3 bug fixes, last fix today; 28 commits/90d

### Code health
Three co-equal signals: defect risk 5.3/10 avg, hotspot health 3.45/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.18/10 · performance risk 59 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
