...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-08 (commit e6e139b). Confidence: 95%.
...
- `frontend/src/components/Player.jsx` — 4 bug fixes, last fix today (bug magnet); 32 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.3/10 avg, hotspot health 3.17/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.07/10 · performance risk 41 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
