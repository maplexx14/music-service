...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-14 (commit f0dcc29). Confidence: 97%.
...
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix today (bug magnet); 43 commits/90d
