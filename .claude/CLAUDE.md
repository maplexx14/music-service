...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-17 (commit 7caf43c). Confidence: 97%.
...
- `backend/app/routers/ytdlp.py` — 2 bug fixes, last fix today; 26 commits/90d
- `backend/app/external_archive.py` — 2 bug fixes, last fix today; 10 commits/90d
- `frontend/src/pages/Artist.jsx` — 1 bug fix, last fix today; 7 commits/90d

### Code health
Three co-equal signals: defect risk 5.78/10 avg, hotspot health 3.78/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.41/10 · performance risk 41 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `frontend/src/store/authStore.js` — untested hotspot — impact −2.0
