...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-11 (commit 11c0a79). Confidence: 97%.
...
- `backend/app/routers/recommendations.py` — 10 bug fixes, last fix yesterday (bug magnet); 31 commits/90d
- `backend/tests/test_flow.py` — 9 bug fixes, last fix 2 weeks ago (bug magnet); 33 commits/90d
- `backend/app/schemas.py` — 7 bug fixes, last fix 11 days ago (bug magnet); 29 commits/90d

### Code health
Three co-equal signals: defect risk 5.22/10 avg, hotspot health 3.36/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.2/10 · performance risk 81 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
