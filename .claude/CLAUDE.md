...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-23 (commit d503d94). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 13 bug fixes, last fix yesterday (bug magnet); 61 commits/90d
...
- `backend/tests/test_recommendation_quality.py` — 3 bug fixes, last fix yesterday; 5 commits/90d

### Code health
Three co-equal signals: defect risk 5.3/10 avg, hotspot health 3.51/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.13/10 · performance risk 73 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
