...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-12 (commit a6eda28). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.27/10 avg, hotspot health 3.44/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.22/10 · performance risk 81 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
