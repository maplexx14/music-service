...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-21 (commit 7d23f89). Confidence: 97%.
...
- `invidious/proxy-pool/rotate.sh` — 3 bug fixes, last fix 2 days ago; 5 commits/90d

### Code health
Three co-equal signals: defect risk 5.36/10 avg, hotspot health 3.47/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.24/10 · performance risk 60 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
