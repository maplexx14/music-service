...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-18 (commit bb21ab3). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 6 bug fixes, last fix today (bug magnet); 42 commits/90d
...
- `invidious/proxy-pool/rotate.sh` — 3 bug fixes, last fix today; 4 commits/90d
- `backend/app/routers/ytdlp.py` — 2 bug fixes, last fix yesterday; 27 commits/90d

### Code health
Three co-equal signals: defect risk 5.78/10 avg, hotspot health 3.93/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.47/10 · performance risk 43 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
