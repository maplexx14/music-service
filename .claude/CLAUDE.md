...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-28 (commit a1433b0). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 16 bug fixes, last fix today (bug magnet); 65 commits/90d
- `backend/tests/test_flow.py` — 9 bug fixes, last fix today (bug magnet); 33 commits/90d
...
- `backend/tests/test_recommendations.py` — 4 bug fixes, last fix today (bug magnet); 8 commits/90d

### Code health
Three co-equal signals: defect risk 5.33/10 avg, hotspot health 3.53/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.2/10 · performance risk 79 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
