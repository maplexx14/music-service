...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-13 (commit 5879671). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.34/10 avg, hotspot health 2.96/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.22/10 · performance risk 43 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
