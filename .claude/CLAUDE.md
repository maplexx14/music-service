...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-07 (commit 1e66ffe). Confidence: 95%.
...
- `frontend/src/components/Player.jsx` — 3 bug fixes, last fix yesterday; 29 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.29/10 avg, hotspot health 3.13/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.06/10 · performance risk 41 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
