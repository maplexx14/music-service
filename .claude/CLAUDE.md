...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-06 (commit 69ece4a). Confidence: 95%.
...
### Code health
Three co-equal signals: defect risk 5.25/10 avg, hotspot health 3.05/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.07/10 · performance risk 41 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
