...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-12 (commit 5da9cab). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 18 bug fixes, last fix yesterday (bug magnet); 67 commits/90d
- `backend/app/routers/ytdlp.py` — 10 bug fixes, last fix today (bug magnet); 36 commits/90d
- `backend/app/routers/recommendations.py` — 10 bug fixes, last fix yesterday (bug magnet); 32 commits/90d
- `backend/tests/test_flow.py` — 9 bug fixes, last fix 2 weeks ago (bug magnet); 33 commits/90d
- `frontend/src/components/Player.jsx` — 8 bug fixes, last fix today (bug magnet); 51 commits/90d

### Code health
Three co-equal signals: defect risk 5.27/10 avg, hotspot health 3.48/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.22/10 · performance risk 81 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
