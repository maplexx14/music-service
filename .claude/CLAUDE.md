...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-27 (commit da8103c). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 14 bug fixes, last fix 2 days ago (bug magnet); 62 commits/90d
- `backend/tests/test_flow.py` — 8 bug fixes, last fix 5 days ago (bug magnet); 31 commits/90d
- `backend/app/routers/recommendations.py` — 6 bug fixes, last fix today (bug magnet); 26 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 13 days ago (bug magnet); 45 commits/90d
- `backend/tests/test_recommendations.py` — 3 bug fixes, last fix today; 7 commits/90d

### Code health
Three co-equal signals: defect risk 5.44/10 avg, hotspot health 3.53/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.17/10 · performance risk 73 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
