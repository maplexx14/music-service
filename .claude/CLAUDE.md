...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-18 (commit 6b5b916). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 3 bug fixes, last fix 2 days ago; 38 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.84/10 avg, hotspot health 3.81/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.46/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
