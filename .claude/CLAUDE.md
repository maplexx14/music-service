...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-25 (commit 60b178e). Confidence: 97%.
...
- `backend/app/routers/ytdlp.py` — 11 bug fixes, last fix 5 days ago (bug magnet); 36 commits/90d
- `frontend/src/components/Player.jsx` — 11 bug fixes, last fix 12 days ago (bug magnet); 51 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.22/10 avg, hotspot health 3.33/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.21/10 · performance risk 85 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
