...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-30 (commit d0b116c). Confidence: 97%.
...
- `backend/app/schemas.py` — 6 bug fixes, last fix today (bug magnet); 28 commits/90d
- `frontend/src/components/Player.jsx` — 6 bug fixes, last fix 2 days ago (bug magnet); 47 commits/90d

### Code health
Three co-equal signals: defect risk 5.36/10 avg, hotspot health 3.56/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.24/10 · performance risk 77 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
