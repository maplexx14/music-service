...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-31 (commit 24eadd5). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.36/10 avg, hotspot health 3.56/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.24/10 · performance risk 76 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
