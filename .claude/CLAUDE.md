...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-26 (commit 895389b). Confidence: 97%.
...
- `frontend/src/components/Player.jsx` — 12 bug fixes, last fix today (bug magnet); 55 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.3/10 avg, hotspot health 3.38/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.26/10 · performance risk 85 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
