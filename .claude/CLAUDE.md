...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-17 (commit b822fb5). Confidence: 97%.
...
- `backend/app/routers/ytdlp.py` — 1 bug fix, last fix today; 24 commits/90d
- `backend/app/external_archive.py` — 1 bug fix, last fix today; 9 commits/90d
- `backend/tests/test_external_resolve.py` — 1 bug fix, last fix today; 3 commits/90d

### Code health
Three co-equal signals: defect risk 5.75/10 avg, hotspot health 3.79/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.41/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
