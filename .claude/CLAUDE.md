...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-28 (commit 90d8970). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.32/10 avg, hotspot health 3.44/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.18/10 · performance risk 82 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
