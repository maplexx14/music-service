...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-09 (commit ea3190b). Confidence: 96%.
...
- `frontend/src/components/Player.jsx` — 4 bug fixes, last fix yesterday (bug magnet); 37 commits/90d
- `frontend/src/services/audioEngine.js` — 1 bug fix, last fix yesterday; 6 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.26/10 avg, hotspot health 3.21/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.06/10 · performance risk 41 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
