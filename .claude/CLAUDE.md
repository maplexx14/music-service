...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-09 (commit 611e262). Confidence: 96%.
...
- `backend/app/routers/ytdlp.py` — 22 commits/90d
- `backend/app/routers/flow.py` — 21 commits/90d

### Code health
Three co-equal signals: defect risk 5.25/10 avg, hotspot health 3.19/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.06/10 · performance risk 41 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
