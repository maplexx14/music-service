...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-27 (commit 5600922). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.46/10 avg, hotspot health 3.56/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.17/10 · performance risk 73 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
