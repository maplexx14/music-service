...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-14 (commit 5d34e78). Confidence: 97%.
...
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix today (bug magnet); 42 commits/90d
- `backend/app/routers/tracks.py` — 1 bug fix, last fix today; 20 commits/90d
- `backend/app/routers/recommendations.py` — 1 bug fix, last fix today; 15 commits/90d
...
### Code health
Three co-equal signals: defect risk 5.44/10 avg, hotspot health 3.13/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.27/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
