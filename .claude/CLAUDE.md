...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-10 (commit 844faf2). Confidence: 96%.
...
- `frontend/src/components/Player.jsx` — 4 bug fixes, last fix yesterday (bug magnet); 39 commits/90d
- `frontend/src/pages/Search.jsx` — 1 bug fix, last fix today; 19 commits/90d
- `frontend/src/services/audioEngine.js` — 1 bug fix, last fix yesterday; 7 commits/90d
- `frontend/src/components/Grainient.jsx` — 1 bug fix, last fix 7 days ago; 3 commits/90d
- `backend/app/routers/ytdlp.py` — 23 commits/90d

### Code health
Three co-equal signals: defect risk 5.33/10 avg, hotspot health 3.41/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.09/10 · performance risk 40 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
