...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-29 (commit 8c8417f). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 16 bug fixes, last fix yesterday (bug magnet); 65 commits/90d
- `backend/tests/test_flow.py` — 9 bug fixes, last fix yesterday (bug magnet); 33 commits/90d
- `backend/app/routers/recommendations.py` — 8 bug fixes, last fix today (bug magnet); 28 commits/90d
- `frontend/src/components/Player.jsx` — 6 bug fixes, last fix today (bug magnet); 46 commits/90d
- `backend/app/routers/aggregate.py` — 5 bug fixes, last fix today (bug magnet); 10 commits/90d

### Code health
Three co-equal signals: defect risk 5.33/10 avg, hotspot health 3.53/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.23/10 · performance risk 77 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
