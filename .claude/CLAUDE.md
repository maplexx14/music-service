...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-14 (commit ea46457). Confidence: 97%.
...
- `frontend/src/components/Player.jsx` — 4 bug fixes, last fix 5 days ago (bug magnet); 41 commits/90d
- `frontend/src/pages/Search.jsx` — 1 bug fix, last fix 4 days ago; 20 commits/90d
- `frontend/src/store/authStore.js` — 1 bug fix, last fix 4 days ago; 5 commits/90d
- `frontend/src/services/audioEngine.js` — 1 bug fix, last fix 5 days ago; 8 commits/90d
- `frontend/src/components/Grainient.jsx` — 1 bug fix, last fix 11 days ago; 3 commits/90d

### Code health
Three co-equal signals: defect risk 5.4/10 avg, hotspot health 3.07/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.22/10 · performance risk 43 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
