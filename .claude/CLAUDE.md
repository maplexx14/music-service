...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-29 (commit 296e6c8). Confidence: 97%.
...
- `backend/app/schemas.py` — 4 bug fixes, last fix today (bug magnet); 26 commits/90d

### Code health
Three co-equal signals: defect risk 5.36/10 avg, hotspot health 3.52/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.22/10 · performance risk 79 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
