...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-20 (commit 7c3200b). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 6 bug fixes, last fix yesterday (bug magnet); 46 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 6 days ago (bug magnet); 45 commits/90d
- `backend/tests/test_flow.py` — 3 bug fixes, last fix yesterday; 21 commits/90d
- `invidious/proxy-pool/rotate.sh` — 3 bug fixes, last fix yesterday; 5 commits/90d
- `backend/app/routers/ytdlp.py` — 2 bug fixes, last fix 2 days ago; 27 commits/90d

### Code health
Three co-equal signals: defect risk 5.61/10 avg, hotspot health 3.59/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.37/10 · performance risk 54 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
