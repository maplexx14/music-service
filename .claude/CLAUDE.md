...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-10 (commit 3cc2b84). Confidence: 96%.
...
- `backend/app/routers/flow.py` — 21 commits/90d

### Code health
Three co-equal signals: defect risk 5.3/10 avg, hotspot health 3.36/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.08/10 · performance risk 40 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
