...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-25 (commit 3836931). Confidence: 97%.
...
- `backend/app/routers/ytdlp.py` — 10 bug fixes, last fix 13 days ago (bug magnet); 36 commits/90d
...
- `frontend/src/components/Player.jsx` — 8 bug fixes, last fix 12 days ago (bug magnet); 51 commits/90d
