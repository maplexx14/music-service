...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-16 (commit 5897192). Confidence: 97%.
...
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 2 days ago (bug magnet); 44 commits/90d
- `backend/app/routers/flow.py` — 3 bug fixes, last fix today; 36 commits/90d
- `backend/app/email_2fa.py` — 1 bug fix, last fix today; 3 commits/90d
- `frontend/src/pages/PlaylistDetail.jsx` — 1 bug fix, last fix yesterday; 10 commits/90d
- `backend/app/routers/tracks.py` — 1 bug fix, last fix 2 days ago; 20 commits/90d

### Code health
Three co-equal signals: defect risk 5.69/10 avg, hotspot health 3.7/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.38/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
