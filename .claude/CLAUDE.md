...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-14 (commit fcf711a). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 5.55/10 avg, hotspot health 3.38/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.3/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
