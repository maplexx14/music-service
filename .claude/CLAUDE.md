...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-26 (commit edc1cf1). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 14 bug fixes, last fix yesterday (bug magnet); 62 commits/90d
- `backend/tests/test_flow.py` — 8 bug fixes, last fix 4 days ago (bug magnet); 31 commits/90d
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix 12 days ago (bug magnet); 45 commits/90d
- `backend/app/routers/recommendations.py` — 4 bug fixes, last fix 4 days ago (bug magnet); 24 commits/90d
- `backend/tests/test_recommendation_quality.py` — 3 bug fixes, last fix 4 days ago; 5 commits/90d

### Code health
Three co-equal signals: defect risk 5.47/10 avg, hotspot health 3.55/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.21/10 · performance risk 73 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `frontend/src/components/FullScreenPlayer.jsx` — untested hotspot — impact −2.0
- `frontend/src/pages/Playlists.jsx` — untested hotspot — impact −2.0
- `frontend/src/pages/Search.jsx` — untested hotspot — impact −2.0
- `frontend/src/store/playerStore.js` — untested hotspot — impact −2.0
- `backend/app/storage.py` — untested hotspot — impact −2.0
