...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-18 (commit 72bc577). Confidence: 97%.
...
- `backend/app/routers/flow.py` — 4 bug fixes, last fix today (bug magnet); 39 commits/90d
...
- `backend/tests/test_flow.py` — 1 bug fix, last fix today; 17 commits/90d

### Code health
Three co-equal signals: defect risk 5.81/10 avg, hotspot health 3.8/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.46/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
