...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-16 (commit db361f9). Confidence: 97%.
...
- `frontend/src/components/Player.jsx` — 5 bug fixes, last fix yesterday (bug magnet); 44 commits/90d
- `backend/app/routers/flow.py` — 2 bug fixes, last fix today; 33 commits/90d
...
- `backend/app/routers/tracks.py` — 1 bug fix, last fix yesterday; 20 commits/90d

### Code health
Three co-equal signals: defect risk 5.67/10 avg, hotspot health 3.7/10 (stable), worst `backend/app/routers/soundcloud.py` at 1.0/10 · maintainability 7.37/10 · performance risk 42 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
